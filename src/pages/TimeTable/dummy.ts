...
export const schedule = {
  day1: [ // 7/11 (금)
    ...
    { startTime: new Date('2025-07-11T19:30:00').getTime(), endTime: new Date('2025-07-11T22:00:00').getTime(), activity: '저녁예배 (기도: 반일섭, 설교: 김근주 교수)' },
  ...
  day2: [ // 7/12 (토)
    ...
    { startTime: new Date('2025-07-12T19:30:00').getTime(), endTime: new Date('2025-07-12T22:00:00').getTime(), activity: '저녁예배 (찬양: 김준영 M, 설교: 권연경 교수)' },
